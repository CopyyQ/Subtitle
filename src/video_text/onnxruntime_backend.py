...
class ONNXRuntimeTextDetectionPredictor:
    """Batched PP-OCRv5 detector using ONNX Runtime CUDA with fused preprocessing."""

    def __init__(self, model_path: str | Path, *, thresh: float = .30, box_thresh: float = .50):
        import onnxruntime as ort
