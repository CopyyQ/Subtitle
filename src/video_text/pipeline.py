...
class SubtitlePipeline:
    ...
    def run(self,input_path,output_path,max_frames=0,coordinate_json=None):
        ...
        metrics={
            ...
            "ppocr_backend_batches":getattr(getattr(self.backend,"predictor",None),"profile_batches",None),
            "ppocr_backend_items":getattr(getattr(self.backend,"predictor",None),"profile_items",None),
            "ppocr_backend_prepare_seconds":getattr(getattr(self.backend,"predictor",None),"profile_prepare_seconds",None),
            "ppocr_backend_infer_seconds":getattr(getattr(self.backend,"predictor",None),"profile_infer_seconds",None),
            "ppocr_backend_postprocess_seconds":getattr(getattr(self.backend,"predictor",None),"profile_postprocess_seconds",None),
            "ppocr_adaptive_gating":self.config.ppocr_adaptive_gating,
            "ppocr_gate_max_skip_frames":self.config.ppocr_gate_max_skip_frames,
            "ppocr_gate_change_threshold":self.config.ppocr_gate_change_threshold,
            "ppocr_gate_bright_net_threshold":self.config.ppocr_gate_bright_net_threshold,
